        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h3 class="m-0 text-dark"><i class="fa fa-cog"></i>&nbsp;Admin Setting</h3>
                            <hr>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-6">
                            <div class="card card-primary card-outline">
                                <div class="card-body box-profile">
                                    <form action="adminsetting.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="redirect_url" value="adminsetting.php">
                                        <?php
                                        if ($error != '') : ?>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-12  pt-3">
                                                    <div class="custom-file editField  hide ">
                                                        <input type="file" class="custom-file-input" id="upload_photo" name="photo" value=<?php echo $photo ?? "" ?>>
                                                        <input type="hidden" name="photo_cropped" id="photo_cropped" value="">
                                                        <label class="custom-file-label" for="adminPhpto">Choose file</label>
                                                    </div>
                                                </div>
